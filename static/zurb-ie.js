...
// Stupid IE won't work with prev(). Screw IE users. They can see fine if the label is a light enough color.
/*
function styleinput(index, input)
{
	...
	label.children("span").css('color','#a0a0a0');
	...
	input.onfocus = function(){
		if (input.value==""){
			label.children("span").css('color','#ccc')     
		}
	}
	...
	input.onkeypress = function(){
		label.children("span").css('color','#fff'); 
	};
}
